...
export const metadata: Metadata = {
  title: "Submit a Deal",
  description:
    "Submit a CRE deal to Rising Tide: $1M–$25M acquisitions across retail, industrial, medical office, and multifamily. LOI within 5 business days for qualified deals.",
  keywords: [
    "submit CRE deal",
